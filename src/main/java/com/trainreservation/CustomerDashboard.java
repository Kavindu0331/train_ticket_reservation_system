...
public class CustomerDashboard extends JFrame {
    ...
    public CustomerDashboard(
        ...
        setTitle("Train Reservation - Customer Dashboard");
        setSize(1000, 650);
    ...
    private void createInterface() {
        ...
        header.setBackground(new Color(15, 75, 140));
        header.setBorder(new EmptyBorder(22, 30, 22, 30));

        JLabel systemTitle =
            new JLabel("Train Reservation System");
        ...
        JLabel welcomeLabel =
            new JLabel("Welcome, " + customerName);
        ...
        JPanel menu = new JPanel(new GridLayout(5, 1, 0, 12));
        menu.setBackground(Color.WHITE);
        menu.setBorder(new EmptyBorder(25, 22, 25, 22));
        menu.setPreferredSize(new Dimension(260, 0));

        JButton searchButton = makeButton("Search Schedules");
        JButton bookingsButton = makeButton("My Bookings");
        JButton profileButton = makeButton("My Profile");
        JButton passwordButton = makeButton("Change Password");
        JButton logoutButton = makeButton("Logout");
        ...
        JLabel subtitle =
            new JLabel("Search trains and manage your bookings");
...
searchButton.addActionListener(event -> {
    ...
    new ScheduleSearchFrame(
        ...
        bookingsButton.addActionListener(event ->
